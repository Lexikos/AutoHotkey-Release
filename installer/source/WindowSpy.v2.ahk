...
class MainWindow {
    ...
    __new() {
        ...
        this.gui.add("Text", "xm+8 y+m", "Update when")
        this.gui.add("Radio", "yp vUpdateWhenCtrlUp checked", "Ctrl key is up")
            .onEvent("Click", Func("onOptionUpdateChange"))
        this.gui.add("Radio", "yp vUpdateWhenCtrlDown", "Ctrl key is down")
            .onEvent("Click", Func("onOptionUpdateChange"))
